...
describe('Registration - Submit Button - Design', () => {
    ...
    before( () => {
        ...
        const selectors = ['//input[@name="name"]', '//input[@name="phone"]', '//input[@name="email"]', '//input[@name="password"]', '//textarea[@name="about"]', '//textarea[@name="goals"]'];     
        const names = ['Kate Saf', '+19163906778', 'gjhghgh@gmail.com', '11111', 'About about', '1. My goals'];
...
it('should verify that submit button background-color is correct in hover state', () => {
    ...
    browser.pause(500);
    const actualBackgrounColorHover = $(elementSelector).getCSSProperty('background-color').parsed.hex;
